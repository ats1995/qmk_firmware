...
[_QW] = { /* Qwerty */
  ...
  {MO(_FN),   KC_RALT,   KC_LCTRL,  KC_LGUI,   KC_LSFT,   KC_SPC,    KC_SPC,    MO(_RS),   MO(_LW),   KC_LALT, KC_NO,/*RSF*/DF(_GAME)}
},
[_GAME] = { // Game
  ...
  {KC_4,      KC_5,      KC_LCTL,   KC_LALT,   KC_LSFT,   KC_SPC,    KC_SPC,    KC_F5,     MO(_LW),   KC_ENT,    KC_ENT,    DF(_QW)}
},
[_RS] = { /* RAISE, symbols */
...
[_US_QW] = { /* US Qwerty */
  ...
  {KC_ESC,    KC_A,      KC_S,      KC_D,      KC_F,      KC_G,      KC_H,      KC_J,      KC_K,      KC_L,      KC_SCLN,   KC_QUOT},
  {KC_BSPC,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,   KC_ENT},
  {MO(_FN),   KC_RALT,   KC_LCTRL,  KC_LGUI,   KC_LSFT,   KC_SPC,    KC_SPC,    MO(_US_RS),MO(_LW),   KC_LALT,   KC_TRNS,   DF(_GAME)}
},
...
[_LW] = { /* LOWER, navigation */
  ...
  {KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_LEFT,   KC_DOWN,  KC_UP,      KC_RGHT,   KC_APP,    KC_NO},
